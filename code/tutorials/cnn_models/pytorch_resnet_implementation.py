...
class block(nn.Module):
    ...
    def __init__(
        ...
        self.expansion = 4  # output_channel = input_channel*expansion
        # This is to convert the "input image channels" to the same as the "block input channels, or intermediate_channels"
...
class ResNet(nn.Module):
    def __init__(self, block, layers, image_channels, num_classes):
        ...
        # Initial Layer: (not relating to ResNet)
        self.conv1 = nn.Conv2d(
